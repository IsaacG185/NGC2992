...
define tbnew_simple_z_fit(lo, hi, par)
{
...
add_slang_function("tbnew_simple_z", ["nH [10^22/cm^2]","z [redshift]"]);

private define tbnew_simple_z_defaults(i)
{
   switch(i)
   {case 0:  return (1, 0, 0, 100); }
   {case 1:  return (0, 0, 0, 10); }   
}
set_param_default_hook("tbnew_simple_z", &tbnew_simple_z_defaults);
